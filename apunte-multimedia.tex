...
Pensemos ahora potenciales requisitos que pueden surgir en cualquier entonro 
...
En cuanto a aplicaciones libres, la mayoría de las distribuciones
ofrecen aplicaciones multimedia para reproducción de audio, podemos 
...
desde el intérprete de comandos, sinembargo existen interfaces gráficas
(GUI) como {\it gmplayer} para utilizarlo. 
\end{itemize}

Las últimas dos aplicaiones, son más versátiles en cuánto a los formatos soportados, 
también reproducen video y son independientes del entorno gráfico, sinembargo 
...
dicha dependencia se establece a nivel de las bibliotecas compartidas, utilizadas
