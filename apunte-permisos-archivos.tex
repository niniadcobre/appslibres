...
Es importante distinguir los tipos de archivos.  
...
creada y manipulada por la mayoría de los usuarios regulares del sistema.  
...
descargamos archivos del correo eletrónico, a través de un editor de texto, 
etc. El formato 
